...
[Live demo](https://patronhill.ru) | [Early-access launch](./docs/LAUNCH.md) | [Documentation](https://patronhill.ru/docs) | [Русская документация](https://patronhill.ru/docs/ru) | [API reference](https://patronhill.ru/api) | [Roadmap](./ROADMAP.md) | [План на русском](./docs/ROADMAP.ru.md) | [Agent integration](./AGENTS.md) | [Security model](./SECURITY.md)
...
<p align="center"><strong><a href="https://patronhill.ru">Открыть демо</a> · <a href="https://patronhill.ru/docs">Посмотреть документацию</a></strong></p>
...
If you want to help shape the early-access launch, follow the checklist in
[docs/LAUNCH.md](./docs/LAUNCH.md) and report blockers in GitHub issues.
Please include OS, Node/Docker versions, and exact command output so fixes are
repeatable.
